...
class Game
  ...
  def main_menu
    ...
    def begin_game
      ...
      puts "Place your cruiser on the Board now, it will need 3 coordinates that are in a straight line. Please choose them, separate them with a comma."
      ship_coords << gets.chomp.tr(",", " ").upcase!
      # ship_coords.each do |placement|
